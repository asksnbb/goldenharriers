         ...
         <div class="col-md-12">
             <div class="privacy-policy">
                 <div class="text-block">
                     ...
                     <p>The School library is a learning resource centre in the widest sense as it houses information resources, expansive reading material and digital data with internet access. The library is well stocked with a wide collection of books and CDs on a variety of subjects. Each computer station has an access to the internet. Children are encouraged to use the internet for reference work to prepare their projects. There are surveillance stations to monitor the students' stations and to ensure that undesirable sites are not explored.</p>
                            ...
                            <div class="isotope-wrapper">
                                <div class="isotope-list gallery-grid-wrap" style="position: relative; height: 923.812px;">
                                    <div id="animated-thumbnials" lg-uid="lg0">
                                        <a href="https://i.imgur.com/7NBnxhv.jpg" class="edu-popup-image edu-gallery-grid isotope-item education" lg-event-uid="&amp;1" style="position: absolute; left: 0%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/7NBnxhv.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/uOEGU3M.jpg" class="edu-popup-image edu-gallery-grid isotope-item marketing" lg-event-uid="&amp;2" style="position: absolute; left: 33.25%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/uOEGU3M.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/lvxWOXL.jpg" class="edu-popup-image edu-gallery-grid isotope-item education health" lg-event-uid="&amp;3" style="position: absolute; left: 66.5833%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/lvxWOXL.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
