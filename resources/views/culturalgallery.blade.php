    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <div class="page-title">
                <h1 class="title">Cultural Gallery</h1>
            </div>
            <ul class="edu-breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item active" aria-current="page">Cultural Gallery</li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div id="masonry-gallery" class="gallery-grid-wrap" style="position: relative; height: 1259.83px;">
            <div id="animated-thumbnials" lg-uid="lg0">
                ...
                @if (count($culturalgallery)>0)
                    @foreach ($culturalgallery as $gallery)
