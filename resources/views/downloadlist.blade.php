    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="table-responsive mt-5">
                <h4 class="font-weight-bold text-center font-weight-bold">Download list</h4><br>
                <table class="table table-primary table-bordered" align="center">
                    ...
                    <tr style="font-style:bold; color:rgb(11, 4, 75);">
                        ...
                        <th class="font-weight-bold">Downloads</th>
                    </tr>
                    ...
                    @if (count($downloads) > 0)
                        ...
                        <tr>
                            ...
                            <td><a target="_blank" style="color:red;" href="{{$download->downloadFile}}">download</a></td>
                        </tr>
                        @endforeach
                    @else
