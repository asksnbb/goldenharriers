    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <div class="page-title">
                <h1 class="title">Dance Room</h1>
            </div>
            <ul class="edu-breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item active" aria-current="page">Dance Room</li>
            </ul>
        </div>
    </div>
         ...
         <div class="col-md-12">
             <div class="privacy-policy">
                 <div class="text-block">
                     <h4 class="text-center">Dance Room</h4> 
                     <p>“School realises the importance of Music and Dance for the holistic development of the students and hence ample opportunity and exposure is given to the students to get a feel of their own potential.”</p>
                            ...
                            <div class="isotope-wrapper">
                                <div class="isotope-list gallery-grid-wrap" style="position: relative; height: 923.812px;">
                                    <div id="animated-thumbnials" lg-uid="lg0">
                                        <a href="https://i.imgur.com/ypEZP7e.jpg" class="edu-popup-image edu-gallery-grid isotope-item education" lg-event-uid="&amp;1" style="position: absolute; left: 0%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/ypEZP7e.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/zd7t5ym.jpg" class="edu-popup-image edu-gallery-grid isotope-item marketing" lg-event-uid="&amp;2" style="position: absolute; left: 33.25%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/zd7t5ym.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/Huh5OjO.jpg" class="edu-popup-image edu-gallery-grid isotope-item education health" lg-event-uid="&amp;3" style="position: absolute; left: 66.5833%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/Huh5OjO.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
