    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <div class="page-title">
                <h1 class="title">School Circulars</h1>
            </div>
            <ul class="edu-breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item active" aria-current="page">School Circulars</li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="table-responsive mt-5">
                <h4 class="font-weight-bold text-center font-weight-bold">School Circulars</h4><br>
                <table class="table table-primary table-bordered" align="center">
                    ...
                    @if (count($circulars) > 0)
                        ...
                        <tr>
                            <td>{{$circular->id}}</td>
                            <td>{{date('d-m-Y', strtotime($circular->created_at))}}</td>
                            <td>{{$circular->subject}}</td>
                            <td><a target="_blank" style="color:red;" href="{{$circular->downloadlink}}">download</a></td>
                        </tr>
                        @endforeach
                    @else
