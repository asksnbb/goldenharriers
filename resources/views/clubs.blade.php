         ...
         <div class="col-md-12">
             <div class="privacy-policy">
                 <div class="text-block">
                     ...
                     <p>“In order to develop the co-scholastic aspects in the students, various clubs have been introduced in the School”</p>
                            ...
                            <div class="isotope-wrapper">
                                <div class="isotope-list gallery-grid-wrap" style="position: relative; height: 923.812px;">
                                    <div id="animated-thumbnials" lg-uid="lg0">
                                        <a href="https://i.imgur.com/fqEArt6.jpg" class="edu-popup-image edu-gallery-grid isotope-item education" lg-event-uid="&amp;1" style="position: absolute; left: 0%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/fqEArt6.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/vaxBy6R.jpg" class="edu-popup-image edu-gallery-grid isotope-item marketing" lg-event-uid="&amp;2" style="position: absolute; left: 33.25%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/vaxBy6R.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
                                        ...
                                        <a href="https://i.imgur.com/jGLcYgH.jpg" class="edu-popup-image edu-gallery-grid isotope-item education health" lg-event-uid="&amp;3" style="position: absolute; left: 66.5833%; top: 0px;" data-abc="true">
                                            <div class="thumbnail">
                                                <img src="https://i.imgur.com/jGLcYgH.jpg" alt="Gallery Image">
                                            </div>
                                            <div class="zoom-icon">
                                                <i class="icon-69"></i>
                                            </div>
